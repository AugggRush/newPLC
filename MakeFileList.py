...
import librosa
import soundfile
dataFilepath = "F:/DATA/LJSpeech-1/LJSpeech-1.0/wavs/"
...
with open("train_files.txt", 'w+') as f:
    for item in filenames[:-100]:
        f.write('F:/DATA/LJSpeech-1/LJSpeech-1.0-16k/'+item+'\n')
with open("test_files.txt", 'w+') as f:
    for item in filenames[-100:]:
        f.write('F:/DATA/LJSpeech-1/LJSpeech-1.0-16k/'+item+'\n')
# with open("mel_files.txt", 'w+') as f:
#     for item in filenames:
#         f.write('D:/VCwork-Py/waveglow-modified/waveglow/mel_spectrograms/'+item+'\n')